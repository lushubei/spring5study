...
import com.xb.vip.spring.mvcframework.orm.annotation.*;
...
public class EntityOperation<T> {
    ...
    public EntityOperation(Class<T> clazz, String pk) throws Exception{
        ...
        this.mappings = getPropertyMapping(getters, setters, fields);
    ...
    Map<String, PropertyMapping> getPropertyMapping(Map<String, Method> getters, Map<String, Method> setters,
                                                    Field[] fields){
    ...
    private void fillPkFieldAndAllColumn(String pk, Field[] fields){
        ...
        try {
            ...
            log.debug("没有找到主键列， 主键列名必须与属性名相同");
        }
